...
async function migrate() {
    ...
    const migrations = [
        ...
        // ────────────────────────────────────────────────
        {
            ...
            db: dbNayaxa,
            sql: `
                CREATE TABLE IF NOT EXISTS nayaxa_users (
                    id         INT AUTO_INCREMENT PRIMARY KEY,
                    username   VARCHAR(50) NOT NULL UNIQUE,
                    name       VARCHAR(255) NOT NULL,
                    email      VARCHAR(255) UNIQUE NULL,
                    password   VARCHAR(255) NOT NULL,
                    role       VARCHAR(50) DEFAULT 'Pengguna Nayaxa',
                    avatar     TEXT NULL,
    ...
    try {
        ...
        // 0. Seed nayaxa_users (superadmin bawaan jika belum ada)
        await dbNayaxa.query(`
            INSERT IGNORE INTO nayaxa_users (id, username, name, email, password, role, is_active)
        ...
        const bapperidaPrompt = `Identitas ANDA: Nayaxa, asisten AI yang dibuat oleh tim IT nayaxa. Jika ditanya siapa pembuat kamu, siapa yang membuat/menciptakan Anda, atau siapa tim di balik Nayaxa, Anda WAJIB menjawab bahwa Anda dibuat oleh tim IT nayaxa. DILARANG KERAS menyebut diri Anda sebagai 'asisten AI Bapperida'.
